...
<body class="goto-here">
						...
						<?php if ($this->session->userdata('logged_in') == FALSE) { ?>
							...
							if (($this->session->userdata('role') == '1')) { ?>
								<div class="col-md-4 pr-4 d-flex topper align-items-center">
									...
									<div class="col-md-4 topper" style="margin-right: 20px">
										<a href="<?= base_url('register') ?>" class=" text">Register</a>
									</div>
								</div>
						<?php }
						} ?>
	...
	<section id="home-section" class="hero">
		<div class="home-slider owl-carousel">
			<div class="slider-item" style="background-image: url(<?= base_url('assets/frontend/') ?>images/9e8b7a32-0401-4c42-a0a7-87aed6f1c695.jpg);">
				<div class="overlay"></div>
				<div class="container">
					<div class="row slider-text justify-content-center align-items-center" data-scrollax-parent="true">

						<div class="col-md-12 ftco-animate text-center">
							<h1 class="mb-2">AYO BELANJA HEWAN TERNAK &amp; HEWAN HIAS</h1>
							<h2 class="subheading mb-4">Di warunghewan.online</h2>
							<p><a href="https://api.whatsapp.com/send?phone=6285290222345&text=Halo, saya mau tanya nih tentang produknya?" class="btn btn-primary">Tanya-tanya?</a></p>
						</div>
			...
			<div class="slider-item" style="background-image: url(<?= base_url('assets/frontend/') ?>images/66917aad-989f-461a-b50d-a93afc09239d.jpg);">
				<div class="overlay"></div>
				<div class="container">
					<div class="row slider-text justify-content-center align-items-center" data-scrollax-parent="true">

						<div class="col-sm-12 ftco-animate text-center">
							<h1 class="mb-2">Hewan Segar &amp; Sehat</h1>
							<h2 class="subheading mb-4">Kami menjamin kualitas sampai ditangan pelanggan</h2>
							<p><a href="https://api.whatsapp.com/send?phone=6285290222345&text=Halo, saya mau tanya nih tentang produknya?" class="btn btn-primary">Tanya-tanya?</a></p>
						</div>
			...
			<div class="row no-gutters ftco-services">
				<div class="col-md-3 text-center d-flex align-self-stretch ftco-animate">
					<div class="media block-6 services mb-md-0 mb-4">
						...
						<div class="media-body">
							<h3 class="heading">Pengiriman ke Seluruh Indonesia</h3>
						</div>
					</div>
				</div>
				<div class="col-md-3 text-center d-flex align-self-stretch ftco-animate">
				...
				<div class="col-md-3 text-center d-flex align-self-stretch ftco-animate">
					<div class="media block-6 services mb-md-0 mb-4">
						...
						<div class="media-body">
							<h3 class="heading">24 Jam Customer Service</h3>
						</div>
					</div>
				</div>
			</div>
			...
			<div class="row">
				...
				foreach ($produk as $data) : ?>
					<div class="col-md-6 col-lg-3 ftco-animate">
						<div class="product">
							<a href="<?= base_url('produk/') . $data->id_produk ?>" class="img-prod"><img class="img-fluid" src="<?= base_url('assets/img/produk/') . $data->img ?>" alt="">
								<div class="overlay"></div>
							</a>
		...
		<div class="container">
			<div class="row">
				<div class="col-sm ftco-animate">
					<a href="#" class="partner"><img src="<?= base_url('assets/frontend/') ?>images/IMG_20200725_122849.jpg" class="img-fluid" alt=""></a>
				</div>
				<div class="col-sm ftco-animate">
					<a href="#" class="partner"><img src="<?= base_url('assets/frontend/') ?>images/IMG_20200724_092011.jpg" class="img-fluid" alt=""></a>
				</div>
				<div class="col-sm ftco-animate">
					<a href="#" class="partner"><img src="<?= base_url('assets/frontend/') ?>images/IMG_20200724_092113.jpg" class="img-fluid" alt=""></a>
				</div>
				<div class="col-sm ftco-animate">
					<a href="#" class="partner"><img src="<?= base_url('assets/frontend/') ?>images/IMG_20200725_122611.jpg" class="img-fluid" alt=""></a>
				</div>
				<div class="col-sm ftco-animate">
					<a href="#" class="partner"><img src="<?= base_url('assets/frontend/') ?>images/IMG_20200726_161039.jpg" class="img-fluid" alt=""></a>
				</div>
			</div>
		</div>
	</section>
			...
			<div class="row mb-5">
				<div class="col-md-3">
					<div class="ftco-footer-widget mb-4">
						...
						<p>Ini adalah Website penjualan hewan</p>
